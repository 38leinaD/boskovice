...
public class WideDoorTile extends DoorTile {

	public WideDoorTile(int x, int y, boolean horizontal, SubTexture texture, SubTexture floorTexture) {
	...
	public void writeVertexData(FloatBuffer buffer) {
		...
		if (horizontal) {
			...
			buffer.put(x+1.0f-(slide)).put(y+0.4f).put(0.0f);
			buffer.put(WorldRenderer.texCoords0[4]).put(WorldRenderer.texCoords0[5]);
			buffer.put(WorldRenderer.normalEast);
			
			buffer.put(x+2.0f-(slide)).put(y+0.4f).put(0.0f);
			buffer.put(WorldRenderer.texCoords0[2]).put(WorldRenderer.texCoords0[3]);
			buffer.put(WorldRenderer.normalEast);
			
			buffer.put(x+1.0f-(slide)).put(y+0.4f).put(1.0f);
			buffer.put(WorldRenderer.texCoords0[6]).put(WorldRenderer.texCoords0[7]);
			buffer.put(WorldRenderer.normalEast);
			
			buffer.put(x+1.0f-(slide)).put(y+0.4f).put(1.0f);
			buffer.put(WorldRenderer.texCoords0[6]).put(WorldRenderer.texCoords0[1]);
			buffer.put(WorldRenderer.normalEast);
			
			buffer.put(x+2.0f-(slide)).put(y+0.4f).put(0.0f);
			buffer.put(WorldRenderer.texCoords0[2]).put(WorldRenderer.texCoords0[5]);
			buffer.put(WorldRenderer.normalEast);
			
			buffer.put(x+2.0f-(slide)).put(y+0.4f).put(1.0f);
			buffer.put(WorldRenderer.texCoords0[0]).put(WorldRenderer.texCoords0[7]);
			buffer.put(WorldRenderer.normalEast);
			
			// Left rail
			buffer.put(x+1.0f-(slide)).put(y+0.6f).put(0.0f);
			buffer.put(WorldRenderer.texCoords0[2]).put(WorldRenderer.texCoords0[3]);
			...
			buffer.put(x+1.0f-(slide)).put(y+0.6f).put(1.0f);
			...
			buffer.put(x+2.0f-(slide)).put(y+0.6f).put(0.0f);
			buffer.put(WorldRenderer.texCoords0[2]).put(WorldRenderer.texCoords0[3]);
			...
			buffer.put(x+2.0f-(slide)).put(y+0.6f).put(1.0f);
